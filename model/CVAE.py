...
class CVAE(nn.Module):
    def __init__(self,
        ...
        # Encoder
        self.encoder = nn.LSTM(input_size=Constants_framewise.NUM_CHORDS + Constants.BEAT_RESOLUTION * 2 * 12, 
    ...
    def encode(self, input_chord, melody_condition, length):
...
#         eps = torch.randn(std.shape)
    ...
    def decode(self, z, melody_condition):
